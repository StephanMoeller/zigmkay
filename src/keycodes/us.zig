...
pub const UNDERLINE = core.KeyCodeFire{ .tap_keycode = KC_MINUS, .tap_modifiers = .{ .left_shift = true } };
...
pub const COLON = core.KeyCodeFire{ .tap_keycode = KC_SEMICOLON, .tap_modifiers = .{ .left_shift = true } };
...
pub const ASTER = core.KeyCodeFire{ .tap_keycode = KC_8, .tap_modifiers = .{ .left_shift = true } };

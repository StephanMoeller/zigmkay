...
pub fn LS(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, LSFT);
}
pub fn RS(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, RSFT);
}
pub fn LC(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, LCTL);
}
pub fn RC(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, RCTL);
}
pub fn LA(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, LALT);
}
pub fn RA(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, RALT);
}
pub fn LG(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, LGUI);
}
pub fn RG(key: KeyCodeWithMods) KeyCodeWithMods {
    return AddMod(key, RGUI);
}
...
const LayerCount = 4;
const KeyCount = 36;
const KeyMap: [LayerCount][KeyCount]TapHoldDef = [LayerCount][KeyCount]TapHoldDef{ [KeyCount]TapHoldDef{ A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F }, [KeyCount]TapHoldDef{ A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F }, [KeyCount]TapHoldDef{ A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F }, [KeyCount]TapHoldDef{ A, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F, A, B, C, D, B, C, D, E, F, A, B, C, D, A, B, C, D, E, F } };
